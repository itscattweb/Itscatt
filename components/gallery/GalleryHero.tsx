...
export default function GalleryHero() {
  const [images, setImages] = useState<GalleryHeroImage[]>([]);
  ...
  useEffect(() => {
    const fetchImages = async () => {
      const { data, error } = await supabase
        ...
        .select("*")
        .limit(4);
      if (!error && data) setImages(data as GalleryHeroImage[]);
    };
    fetchImages();
  }, []);
        ...
        <div className="grid grid-cols-1 gap-16 md:grid-cols-2 md:items-center">
          ...
          <div>
            ...
            >
              ...
              moments that tell the story of transformation, one child at a
              time. Every photograph is a chapter in a larger story of hope.
            </p>
                ...
                >
                  <div
                    ...
                    style={{
                      fontFamily: "'Playfair Display', serif",
                      background:
                        "linear-gradient(160deg, #1e3a5f, #1d4ed8, #0ea5e9)",
                      WebkitBackgroundClip: "text",
                      WebkitTextFillColor: "transparent",
                      backgroundClip: "text",
                    }}
          ...
          <div className="relative h-[480px]">
            {/* Main large image */}
            {/* Main large image */}
            <div className="absolute left-0 top-0 h-72 w-[65%] overflow-hidden rounded-3xl border border-blue-100 shadow-lg shadow-blue-50">
              {main ? (
                <img
                  src={main.src}
                  alt={main.title}
            ...
            {/* Top right image */}
            <div className="absolute right-0 top-4 h-44 w-[33%] overflow-hidden rounded-2xl border border-blue-100 shadow-md shadow-blue-50">
              {topRight ? (
                <img
                  src={topRight.src}
                  alt={topRight.title}
            ...
            {/* Bottom left image */}
            <div className="absolute bottom-0 left-8 h-48 w-[40%] overflow-hidden rounded-2xl border border-blue-100 shadow-md shadow-blue-50">
              {bottomLeft ? (
                <img
                  src={bottomLeft.src}
            ...
            {/* Bottom right image */}
            <div className="absolute bottom-4 right-0 h-56 w-[55%] overflow-hidden rounded-3xl border border-blue-100 shadow-lg shadow-blue-50">
              {bottomRight ? (
                <img
                  src={bottomRight.src}
